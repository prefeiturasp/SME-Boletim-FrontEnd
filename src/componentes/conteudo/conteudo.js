...
const Conteudo = () => {
    ...
    return (_jsx("div", { className: "conteudo-principal", children: _jsx(Row, { gutter: [16, 16], children: _jsx(Col, { span: 24, children: _jsx(Card, { title: _jsx("div", { children: _jsx(Select, { showSearch: true, placeholder: "Selecione uma aplica\u00E7\u00E3o...", style: { width: "100%" }, onChange: handleChange, value: nomeAplicacao.id || undefined, notFoundContent: "Nenhuma aplica\u00E7\u00E3o encontrada", filterOption: (input, option) => option?.label.toLowerCase().includes(input.toLowerCase()), options: opcoes }) }), variant: "borderless", children: _jsxs(Tabs, { activeKey: activeTab, onChange: (key) => dispatch(setActiveTab(key)), children: [_jsx(Tabs.TabPane, { tab: "Principal", disabled: abasDesabilitadas, children: _jsx(Principal, {}) }, "1"), _jsx(Tabs.TabPane, { tab: "Turma", disabled: abasDesabilitadas, children: _jsx(Turma, {}) }, "2"), _jsx(Tabs.TabPane, { tab: "Estudantes", disabled: abasDesabilitadas, children: _jsx(Estudantes, {}) }, "3"), _jsx(Tabs.TabPane, { tab: "Resultado por Probabilidade", disabled: abasDesabilitadas, children: _jsx(Resultado, {}) }, "4")] }) }) }) }) }));
};
