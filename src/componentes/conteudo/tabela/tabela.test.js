...
describe("Tabela", () => {
    ...
    it("renderiza tabela com dados", () => {
        render(_jsx(Tabela, { dados: mockDados, origem: "principal", estaCarregando: false }));
    ...
    it("mostra mensagem de vazio quando dados estão vazios", () => {
        render(_jsx(Tabela, { dados: [], origem: "principal", estaCarregando: false }));
    ...
    it("executa drag and drop entre colunas", () => {
        render(_jsx(Tabela, { dados: mockDados, origem: "principal", estaCarregando: false }));
        const draggableHeaders = screen.getAllByText(/Componente curricular|Abaixo do básico|Básico|Adequado|Avançado|Total|Média de proficiência/);
